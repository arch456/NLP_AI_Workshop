...
variable <- 23
variable <- 23.6567
# To view the value, run the variable name
var
# or
print(var)
...
# Reading a text file
# There are a number of ways to read a text file into R. The simplest way to read a plain text file is with the readLines() function, 
# which reads each line as a separate character vector.
